<?php 
	...
	$sql="select a.*,b.cname from Product a,Categories b where a.cid=b.cid order by pid asc";
		...
		switch($_GET["action"]){
			case "add":
				if (!empty($_POST["quantity"])){ 
					...
					$itemArray = array($r[0]["code"]=>array("pid"=>$r[0]["pid"],"pname"=>$r[0]["pname"],"code"=>$r[0]["code"],"pprice"=>$r[0]["pprice"],"pquantity"=>$_POST["quantity"],"pimage"=>$r[0]["pimage"]));
					//var_dump($itemArray);
					/*
