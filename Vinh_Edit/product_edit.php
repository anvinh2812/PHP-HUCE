<?php 
	...
	$sql = "SELECT * FROM product WHERE pid=$pid"; // Truy vấn dữ liệu từ bảng product
		...
		<form method=POST action="product_edit_action.php?pid=<?php echo $pid;?>">
			<table border=0 align=center width=400>
				...
				<tr>
					...
					<td>
						<input type=radio <?php if ($row["pstatus"] == 'Active') echo "checked";?> name=rdPstatus value="Active">Active
						<input type=radio <?php if ($row["pstatus"] == 'Inactive') echo "checked";?> name=rdPstatus value="Inactive">Inactive
					</td>
				</tr>
				<tr>
